							...
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<!-- Code php  -->
										<?php  $con = mysqli_connect('localhost','root','','trjalal');
											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
											   ...
											   <?php	while($data=mysqli_fetch_assoc($run)){ ?>
													...
													<tr>
														...
														<td class="hidden-480"><?php echo $data['ADRESSE PERSONNELLE']; ?></td>
														<td><?php echo $data['N° CNSS']; ?></td>

														<td class="hidden-480">
															<span class="label label-sm label-warning"><?php echo $data['email']; ?></span>
														</td>
														...
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																...
																<a class="red" href="deleteForm.php?sid=<?php echo $data['NOM']; ?>">
