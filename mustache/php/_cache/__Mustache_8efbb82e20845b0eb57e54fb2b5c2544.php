...
class __Mustache_8efbb82e20845b0eb57e54fb2b5c2544 extends Mustache_Template
{
...
';
        ...
        $value = $this->resolveValue($context->findDot('site.version'), $context);
...
';
        ...
        $buffer .= $this->sectionCf7e7218bbc1f585bf7f4e226ef272e8($context, $indent, $value);
        $buffer .= $indent . '	<!-- /section:pages/dashboard.infobox -->
';
        $buffer .= $indent . '	<div class="space-6"></div>
';
...
';
    ...
    private function sectionCf7e7218bbc1f585bf7f4e226ef272e8(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
