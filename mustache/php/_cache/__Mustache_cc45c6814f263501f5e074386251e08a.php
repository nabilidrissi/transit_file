...
class __Mustache_cc45c6814f263501f5e074386251e08a extends Mustache_Template
{
...
';
        $buffer .= $indent . '		<div class="ace-settings-item">
';
        $buffer .= $indent . '			<input type="checkbox" class="ace ace-checkbox-2 ace-save-state" id="ace-settings-navbar" autocomplete="off" />
';
...
';
        $buffer .= $indent . '		<div class="ace-settings-item">
';
        $buffer .= $indent . '			<input type="checkbox" class="ace ace-checkbox-2 ace-save-state" id="ace-settings-sidebar" autocomplete="off" />
';
...
';
        $buffer .= $indent . '		<div class="ace-settings-item">
';
        $buffer .= $indent . '			<input type="checkbox" class="ace ace-checkbox-2 ace-save-state" id="ace-settings-breadcrumbs" autocomplete="off" />
';
...
';
        $buffer .= $indent . '		<div class="ace-settings-item">
';
        $buffer .= $indent . '			<input type="checkbox" class="ace ace-checkbox-2" id="ace-settings-rtl" autocomplete="off" />
';
...
';
        $buffer .= $indent . '		<div class="ace-settings-item">
';
        $buffer .= $indent . '			<input type="checkbox" class="ace ace-checkbox-2 ace-save-state" id="ace-settings-add-container" autocomplete="off" />
';
...
';
        $buffer .= $indent . '		<div class="ace-settings-item">
';
        $buffer .= $indent . '			<input type="checkbox" class="ace ace-checkbox-2" id="ace-settings-hover" autocomplete="off" />
';
...
';
        $buffer .= $indent . '		<div class="ace-settings-item">
';
        $buffer .= $indent . '			<input type="checkbox" class="ace ace-checkbox-2" id="ace-settings-compact" autocomplete="off" />
';
...
';
        $buffer .= $indent . '		<div class="ace-settings-item">
';
        $buffer .= $indent . '			<input type="checkbox" class="ace ace-checkbox-2" id="ace-settings-highlight" autocomplete="off" />
';
